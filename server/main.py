...
from .models import user, client, product, requisition, notification  # garante registro dos modelos no SQLAlchemy
from .routers import auth, users, clients, products, requisitions, notifications
